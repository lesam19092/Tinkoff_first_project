...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, Long> CHAT_ID =
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super Long, ? super String, ? super Long, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from) {
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function5<? super Long, ? super String, ? super Long, ? super OffsetDateTime, ? super OffsetDateTime, ? extends U> from
    ) {
