...
public class LinksSofRecord extends UpdatableRecordImpl<LinksSofRecord> implements Record4<Long, Long, Long, Long> {
    ...
    @Override
    @NotNull
    public LinksSofRecord values(@NotNull Long value1, @NotNull Long value2, @NotNull Long value3, @NotNull Long value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinksSofRecord(@NotNull Long id, @NotNull Long linkId, @NotNull Long countofanswers, @NotNull Long countofcomments) {
        super(LinksSof.LINKS_SOF);
