...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record5<Long, String, Long, OffsetDateTime, OffsetDateTime> {
    ...
    @Override
    @NotNull
    public LinkRecord values(@NotNull Long value1, @NotNull String value2, @NotNull Long value3, @NotNull OffsetDateTime value4, @NotNull OffsetDateTime value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public LinkRecord(@NotNull Long id, @NotNull String url, @NotNull Long chatId, @NotNull OffsetDateTime lastCheckTime, @NotNull OffsetDateTime createdAt) {
        super(Link.LINK);
     ...
     * Create a detached, initialised LinkRecord
     */
    public LinkRecord(edu.java.jooq.tables.pojos.Link value) {
        super(Link.LINK);
